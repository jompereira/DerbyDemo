...
#include "DerbyDemoOffroadCar.h"
#include "DerbyDemoOffroadWheelFront.h"
#include "DerbyDemoOffroadWheelRear.h"
...
ADerbyDemoOffroadCar::ADerbyDemoOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDerbyDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDerbyDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDerbyDemoOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDerbyDemoOffroadWheelRear::StaticClass();
