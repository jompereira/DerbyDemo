...
#include "DerbyDemoSportsCar.h"
#include "DerbyDemoSportsWheelFront.h"
#include "DerbyDemoSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADerbyDemoSportsCar::ADerbyDemoSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDerbyDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDerbyDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDerbyDemoSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDerbyDemoSportsWheelRear::StaticClass();
